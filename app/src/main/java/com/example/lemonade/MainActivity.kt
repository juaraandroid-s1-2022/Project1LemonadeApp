...
class MainActivity : AppCompatActivity() {
	...
	private fun setViewElements() {
		...
		when (lemonadeState) {
			...
			SELECT -> {
				selectedText = R.string.lemon_select
				selectedImage = R.drawable.lemon_tree
			}
			SQUEEZE -> {
				selectedText = R.string.lemon_squeeze
				selectedImage = R.drawable.lemon_squeeze
			}
			DRINK -> {
				selectedText = R.string.lemon_drink
				selectedImage = R.drawable.lemon_drink
			}
			RESTART -> {
				selectedText = R.string.lemon_empty_glass
				selectedImage = R.drawable.lemon_restart
			}
		}
		
		textAction.setText(selectedText)
		lemonImage?.setImageResource(selectedImage)
	}
